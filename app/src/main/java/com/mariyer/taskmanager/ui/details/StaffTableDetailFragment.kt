...
class StaffTableDetailFragment: Fragment(R.layout.fragment_staff_table_detail) {
    private val viewModel: StaffTableDetailViewModel by viewModels()
    private val args: StaffTableDetailFragmentArgs by navArgs()
    private var departList = emptyList<String>()
    private var postList = emptyList<String>()

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        toolbar.title = "Информация о позиции штатного расписания"
